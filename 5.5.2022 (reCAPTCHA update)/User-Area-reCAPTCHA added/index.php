...
<!--reCAPTCHA:::--> <script src="https://www.google.com/recaptcha/api.js" async defer></script><!--reCAPTCHA:::-->
...
<body>
    <div id="navbar">
    <a class="navbarButton" onclick="home()"><i class="fa-solid fa-house"></i> Home</a>
            ...
            <form action="registration.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" class="inputPass" required><br><br>
                      ...
                      data-sitekey="xxxxxxxxxxxxxxxxxxxxxxxxxxx"></div>
                    <!--reCAPTCHA:::-->
                    
                    </center>

                <br>
                <button type="submit" id='btnreg' class="registerBTN" disabled>Register</button>
